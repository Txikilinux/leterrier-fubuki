...
[Files]
Source: "../src/release/leterrier-fubuki.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "../debian/*.desktop"; DestDir: "{app}"; Flags: ignoreversion
;Source: "../src/data/*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Source: "../src/data/icones/leterrier-fubuki-128.png"; DestDir: "{app}"; Flags: ignoreversion
